...
const en: LegalDoc = {
  ...
  summary: {
    h: "The short version",
    ul: [
      "You do not need an account. We do not ask for your name, phone number, email address, or location.",
      "We keep brief technical records of requests so the service stays available and is not abused.",
      "BizIntel tells you whether an area looks under-supplied or over-supplied for a type of business. It does not tell you whether your business will succeed.",
      "The map data misses many informal businesses, so an area that looks empty may simply be unmapped. Visit the area before you decide.",
      "The written commentary at the end of a result is generated by an AI model. Treat it as a suggestion to check, not a finding.",
    ],
    note: "The full text below is what applies. The summary is only here to make it easier to follow.",
  },
...
const rw: LegalDoc = {
  ...
  summary: {
    h: "Muri make",
    ul: [
      "Ntugomba gufungura konti. Ntitugusaba amazina yawe, nimero ya telefone, imeyili, cyangwa aho uherereye.",
      "Dubika amakuru make ya tekiniki ku byifuzo kugira ngo serivisi ikomeze gukora kandi itagirwaho ikibazo cyo gukoreshwa nabi.",
      "BizIntel ikubwira niba ahantu hasa nk'aho hari ubucuruzi buke cyangwa bwinshi bw'ubwoko wahisemo. Ntabwo ikubwira niba ubucuruzi bwawe buzatera imbere.",
      "Amakuru y'ikarita dukoresha asiga inyuma ubucuruzi bwinshi butanditse, bityo ahantu hasa nk'aho hadafite ubucuruzi hashobora kuba hatarandikwa gusa. Sura aho hantu mbere yo gufata icyemezo.",
      "Ubusobanuro bwanditse buboneka munsi y'ibisubizo bukorwa n'ubwenge bw'ubukorano (AI). Bufate nk'igitekerezo cyo gusuzuma, atari icyemezo cya nyacyo.",
    ],
    note: "Inyandiko yuzuye iri hepfo ni yo ikurikizwa. Iyi ncamake iri hano kugira ngo byorohe kumva gusa.",
  },
